                  ...
                  <div class="col-xl-6">
                     <div class="card custom-card">
                        <div class="card-header justify-content-between">
                           <div class="card-title"> Modifier Colis </div>
                        ...
                        <div class="card-body">
                        <form action="/modifColis" method="POST">
                        @csrf
                        <input type="hidden" name="id" value="{{$data->id}}">
                           <div class="mb-3"> <label for="Description" class="form-label fs-14 text-dark" spaceholder="Description">Description</label> <input type="text" class="form-control" id="Description" placeholder="Description" name="Description" value="{{$data->Description}}"></div>
                           <div class="mb-3"> <label for="Qte" class="form-label fs-14 text-dark" spaceholder="Qte">Qte</label> <input type="number" class="form-control" id="Qte" placeholder="Qte" name="Qte" value="{{$data->Qte}}"> </div>
                           <div class="mb-3"> <label for="Prix" class="form-label fs-14 text-dark" spaceholder="Prix">Prix</label> <input type="number" class="form-control" id="Prix" placeholder="Prix" name="Prix" value="{{$data->Prix}}"> </div>
                           <div class="mb-3"> <label for="nc" class="form-label fs-14 text-dark" spaceholder="Nom Client">Nom Client</label> <input type="text" class="form-control" id="nc" placeholder="Nom Client" name="Nom Client" value="{{$data->Nom_Client}}"> </div>
                           <div class="mb-3"> <label for="ec" class="form-label fs-14 text-dark" spaceholder="Email Client">Email Client</label> <input type="email" class="form-control" id="ec" placeholder="Email Client" name="Email Client" value="{{$data->Email_Client}}"> </div>
                           <div class="mb-3"> <label for="tc" class="form-label fs-14 text-dark" spaceholder="Tel Client">Tel Client</label> <input type="tel" class="form-control" id="ec" placeholder="Tel Client" name="Tel Client" value="{{$data->Tel_Client}}"> </div>
                           <div class="mb-3"> <label for="ac" class="form-label fs-14 text-dark" spaceholder="Adresse Client">Adresse Client</label> <input type="text" class="form-control" id="ec" placeholder="Adresse Client" name="Adresse Client" value="{{$data->Adresse_Client}}"> </div>
                           <div class="mb-3"> <label for="et" class="form-label fs-14 text-dark" spaceholder="Etat">Etat</label> <input type="text" class="form-control" id="et" placeholder="Etat" name="Etat" value="{{$data->Etat}}"> </div>
                           <div class="mb-3"> <label for="pw" class="form-label fs-14 text-dark" spaceholder="Password">Password</label> <input type="password" class="form-control" id="pw" placeholder="Password" name="Password" value="{{$data->Password}}"> </div>
