                  ...
                  <div class="col-xl-6">
                     <div class="card custom-card">
                        <div class="card-header justify-content-between">
                           <div class="card-title"> Ajout Admis </div>
                        ...
                        @csrf
                           ...
                           <div class="mb-3"> <label for="Email" class="form-label fs-14 text-dark" spaceholder="Email">Email</label> <input type="email" class="form-control" id="Email" placeholder="Email" name="Email"> </div>
                           ...
                           <div class="mb-3"> <label for="Password" class="form-label fs-14 text-dark" spaceholder="Password">Password</label> <input type="password" class="form-control" id="Password" placeholder="Password" name="password"> </div>
