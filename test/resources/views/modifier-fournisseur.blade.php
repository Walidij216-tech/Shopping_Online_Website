                  ...
                  <div class="col-xl-6">
                     <div class="card custom-card">
                        <div class="card-header justify-content-between">
                           <div class="card-title"> Modifier Founisseur </div>
                        ...
                        <div class="card-body">
                        <form action="/modifFournisseur" method="POST">
                        @csrf
                        <input type="hidden" name="id" value="{{$data->id}}">
                           <div class="mb-3"> <label for="form-text" class="form-label fs-14 text-dark">Name </label> <input type="text" class="form-control" id="Name" placeholder="Name" name="Name" value="{{$data->Name}}"> </div>
                           <div class="mb-3"> <label for="Email" class="form-label fs-14 text-dark" spaceholder="Email">Email</label> <input type="text" class="form-control" id="Email" placeholder="Email" name="Email" value="{{$data->Email}}"> </div>
                           <div class="mb-3"> <label for="Login" class="form-label fs-14 text-dark" spaceholder="Login">Login</label> <input type="text" class="form-control" id="Login" placeholder="Login" name="Login" value="{{$data->Login}}"> </div>
                           <div class="mb-3"> <label for="Adresse" class="form-label fs-14 text-dark" spaceholder="Adresse">Adresse</label> <input type="text" class="form-control" id="Adresse" placeholder="Adresse" name="Adresse" value="{{$data->Adresse}}"> </div>
                           <div class="mb-3"> <label for="Tel" class="form-label fs-14 text-dark" spaceholder="Tel">Tel</label> <input type="tel" class="form-control" id="Tel" placeholder="Tel" name="Tel" value="{{$data->Tel}}"> </div>
