                  ...
                  <div class="col-xl-6">
                     <div class="card custom-card">
                        ...
                        <input type="hidden" name="id" value="{{$data->id}}">
                           ...
                           <div class="mb-3"> <label for="Description" class="form-label fs-14 text-dark">Description</label> <input type="text" class="form-control" id="Description" placeholder="Description" name="Description" value="{{$data->Description}}"></div>
