                  ...
                  <div class="col-xl-12">
                     <div class="card custom-card">
                        <div class="card-header">
                           <div class="card-title"> Liste Categorie</div>
                        </div>
                        <div class="card-body">
                           <table id="datatable-basic" class="table table-bordered text-nowrap" style="width:100%">
                              ...
                              @foreach($data as $item)
                                 <tr>
                                    ...
                                    <td> <a href="modifier-categorie/{{$item->id}}" class="btn btn-success">Modifier</a>
                                       <a href="/suppCategorie/{{$item->id}}" class="btn btn-danger">Supprimer</a>
                                       </td>
