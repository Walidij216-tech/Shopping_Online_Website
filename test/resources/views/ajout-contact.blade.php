                  ...
                  <div class="col-xl-6">
                     <div class="card custom-card">
                        <div class="card-header justify-content-between">
                           <div class="card-title"> Ajout Contact </div>
                        ...
                        @csrf
                           ...
                           <div class="mb-3"> <label for="s" class="form-label fs-14 text-dark" spaceholder="Sujet">Sujet</label> <input type="text" class="form-control" id="s" placeholder="Sujet" name="Sujet"> </div>
                           <div class="mb-3"> <label for="Message" class="form-label fs-14 text-dark" spaceholder="Message">Message</label> <input type="text" class="form-control" id="msg" placeholder="Message" name="Message" ></div>
