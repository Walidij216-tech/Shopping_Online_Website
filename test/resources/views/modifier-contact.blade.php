               ...
               <div class="row">
                  <div class="col-xl-6">
                     <div class="card custom-card">
                        ...
                        <div class="card-body">
                        <form action="/modifContact" method="POST">
                        @csrf
                        <input type="hidden" name="id" value="{{$data->id}}">
                           ...
                           <div class="mb-3"> <label for="s" class="form-label fs-14 text-dark" spaceholder="Sujet">Sujet</label> <input type="text" class="form-control" id="s" placeholder="Sujet" name="Sujet" value="{{$data->Sujet}}"> </div>
                           <div class="mb-3"> <label for="Message" class="form-label fs-14 text-dark" spaceholder="Message">Message</label> <input type="text" class="form-control" id="msg" placeholder="Message" name="Message" value="{{$data->Message}}"></div>
